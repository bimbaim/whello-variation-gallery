jQuery(document).ready(function($) {
    ...
    $(document).on('click', '.whvg-gallery-add-button', function(event){
        ...
        meta_image_frame.on('select', function(){
            ...
            selection.map(function(attachment) {
                ...
                gallery.find('ul.whvg-gallery-images').append("<li data-id=\""+attachment.id+"\"><img src=" +attachment.url+ " /></li>");
            });
    ...
    $(document).on('click', 'ul.whvg-gallery-images li', function(event){
    	event.preventDefault ? event.preventDefault() : (event.returnValue = false);
